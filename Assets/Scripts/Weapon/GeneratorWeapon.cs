...
public class GeneratorWeapon : Spawner<Weapon>
{
    ...
    [SerializeField] private float _swordSpreadAngle = 25f;     // ���� ��� �����
    [SerializeField] private float _swordOffsetDistance = 0.4f; // �������� �� ������
    ...
    public void SetSwordOffsetDistance(float distance)
    {
        _swordOffsetDistance = distance;
    }
    ...
    public void SpawnSwordBurst()
    {
        ...
        Debug.Log($"[Sword] SpawnSwordBurst: count={count}, spread={_swordSpreadAngle}");
