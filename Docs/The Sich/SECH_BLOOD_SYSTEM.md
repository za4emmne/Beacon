...
- **v1.4** — Завершена реализация всех компонентов: BloodSplatterManager, BloodDecal, BloodParticles, BloodTrailEmitter
- **v1.5** — Интеграция с EnemyHealth и PlayerHealth для автоматического запуска эффектов крови при получении урона и смерти
